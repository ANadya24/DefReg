...
# python3 EPE_vizualize_deformations.py --sequence_path '/srv/fast1/n.anoshina/DefReg/data/SeqB/SeqB1.tif' --prediction_path '/srv/fast1/n.anoshina/DefReg/predictions/test_exp1/defregnet_points_error_l2/' --base_prediction_path '/srv/fast1/n.anoshina/DefReg/data/dots_drawing/elastic/' --save_drawing_path '/srv/fast1/n.anoshina/DefReg/EPE_results/SeqB1/viz/'
